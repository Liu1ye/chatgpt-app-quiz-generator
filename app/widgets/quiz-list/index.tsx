...
const dataList = () => {
   ...
   const handleClickItem = (qd: QuizData) => {
    ...
    return (
        <>
            {
                currentQuiz ? <Quiz isFromList quizDataFromList={currentQuiz} onClickBackToList={() => setCurrentQuiz(null)} />  :  <div className="flex flex-col w-full h-[475px] bg-bg-primary">
                <div className="p-[16px_10px_16px_16px]">
                    <span className="text-text-primary text-[17px] font-[510]">My Quizzes</span> 
